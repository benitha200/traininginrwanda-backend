...
//         try {
//           // Generate both PDFs
//           const acceptancePdfPath = await generateAcceptanceLetter(course, personalInfo);
//           const invoicePdfPath = await generateInvoice(course, personalInfo);

//           // Send Email with both attachments
//           await sendEnrollmentEmail(personalInfo.email, course, acceptancePdfPath, invoicePdfPath);
...
// function generateAcceptanceLetter(course, personalInfo) {
//   return new Promise((resolve, reject) => {
//     const doc = new PDFDocument();
//     const pdfPath = path.join(__dirname, '../pdfs', `acceptance_${Date.now()}.pdf`);
...
//       .moveDown()
//       .text('We are pleased to inform you that your enrollment has been accepted for:')
//       .moveDown()
//       .fontSize(14)
//       .text(course.title, { indent: 20 })
//       .moveDown()
//       .fontSize(12)
//       .text(`Course Details:`, { continued: true })
//       .moveDown()
//       .text(`Start Date: ${course.start_date}`, { indent: 20 })
//       .text(`End Date: ${course.end_date}`, { indent: 20 })
//       .text(`Location: ${course.location || 'To be announced'}`, { indent: 20 })
//       .moveDown(2)
//       .text('Please find the attached invoice for the course fees. Payment details are included in the invoice.')
//       .moveDown(2)
//       .text('We look forward to welcoming you to the program.')
//       .moveDown(2)
//       .text('Best regards,')
//       .moveDown()
...
// function generateInvoice(course, personalInfo) {
//   return new Promise((resolve, reject) => {
//     const doc = new PDFDocument();
...
//     doc
//       .fontSize(12)
//       .text('Training Center Name', { align: 'left' })
//       .text('Address Line 1')
//       .text('City, Country')
//       .text('Phone: +123 456 789')
//       .text('Email: contact@trainingcenter.com')
//       .moveDown(2);
...
//       .text('Amount', 400, startY)
//       .moveDown();

//     // Line Item
//     doc
//       .text(course.title, 50)
//       .text(`$${course.price.toFixed(2)}`, 400);
...
//       .text('Account Name: Training Center Ltd')
...
// async function sendEnrollmentEmail(email, course, acceptancePath, invoicePath) {
//   const mailOptions = {
//     from: 'benithalouange@gmail.com',
//     to: email,
...
// Please make the payment according to the instructions in the invoice.
